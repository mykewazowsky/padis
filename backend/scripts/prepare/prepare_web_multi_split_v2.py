"""
prepare_web_multi_split_v2.py

Generate web layer multi-hazard v2 untuk seluruh skenario
...
for rp, cols in scenarios.items():
    for climate_key, loss_col in cols.items():
        print(f"\nMenyiapkan multi {climate_key} {rp} ...")
        ...
        output_path = os.path.join(
            OUTPUT_DIR,
            f"web_multi_{climate_key}_{rp}_v2.geojson"
        )
...
print("\nSelesai: web multi-hazard v2 siap.")
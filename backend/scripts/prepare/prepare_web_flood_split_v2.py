"""
prepare_web_flood_split_v2.py

Generate web layer flood v2 untuk seluruh skenario
...
scenarios = {
    "rp25": {
        "nonclimate": "loss_flood_nonclimate_rp25",
        "climate": "loss_flood_climate_rp25",
    },
    "rp50": {
        "nonclimate": "loss_flood_nonclimate_rp50",
        "climate": "loss_flood_climate_rp50",
    },
    "rp100": {
        "nonclimate": "loss_flood_nonclimate_rp100",
        "climate": "loss_flood_climate_rp100",
    },
    "rp250": {
        "nonclimate": "loss_flood_nonclimate_rp250",
        "climate": "loss_flood_climate_rp250",
    },
}
...
for rp, cols in scenarios.items():
    for climate_key, loss_col in cols.items():
        print(f"\nMenyiapkan flood {climate_key} {rp} ...")
        ...
        output_path = os.path.join(
            OUTPUT_DIR,
            f"web_flood_{climate_key}_{rp}_v2.geojson"
        )
